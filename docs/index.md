...
[Install Valkey :material-arrow-right:](installation/installation.md){ .md-button }

</div><div data-banner markdown>

## :octicons-arrow-switch-16: Migration guide { .title }

Wish to switch to Valkey? Check out the migration guide for **testing and evaluation** scenarios.
